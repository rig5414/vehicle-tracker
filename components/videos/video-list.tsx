...
export function VideoList() {
  ...
  const [videos, setVideos] = useState<Video[]>([
    {
      id: '1',
      title: 'Nairobi CBD Traffic',
      description: 'Footage from Moi Avenue, Nairobi',
      location: 'Nairobi, Moi Avenue',
      status: 'COMPLETED',
      createdAt: new Date(),
      thumbnailUrl: 'https://placehold.co/320x180?text=Nairobi',
      plateCount: 3,
    },
    {
      id: '2',
      title: 'Mombasa Road Surveillance',
      description: 'Afternoon traffic on Mombasa Road',
      location: 'Mombasa Road, Nairobi',
      status: 'PROCESSING',
      createdAt: new Date(),
      thumbnailUrl: 'https://placehold.co/320x180?text=Mombasa+Road',
      plateCount: 0,
    },
    {
      id: '3',
      title: 'Kisumu Market Area',
      description: 'Busy day at Kisumu Main Market',
      location: 'Kisumu, Main Market',
      status: 'PENDING',
      createdAt: new Date(),
      thumbnailUrl: 'https://placehold.co/320x180?text=Kisumu',
      plateCount: 0,
    },
    {
      id: '4',
      title: 'Thika Superhighway Morning',
      description: 'Morning rush hour on Thika Superhighway',
      location: 'Thika Superhighway, Nairobi',
      status: 'FAILED',
      createdAt: new Date(),
      thumbnailUrl: 'https://placehold.co/320x180?text=Thika+Superhighway',
      plateCount: 0,
    },
  ]);
